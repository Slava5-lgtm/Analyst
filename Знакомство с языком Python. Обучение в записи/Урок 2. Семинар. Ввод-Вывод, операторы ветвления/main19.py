...
if i - j == 0:     # если разность нашех чисел i - j равняеться нулю то мы не сможем дать наш верный результат
    ...
    print(f'В нашей элекрички - {i+j-1} вагонов')   # если нумерация начинаеится с конца поезда то мы будем уже выдовать верный результат соотвествено давайте будим
                                                    # складывать два числа i и j чтобы знать сколько вагонов у нас всего но мы также будим вычитать единицу так как наш
                                                    # вагон будит считаться два раза 
