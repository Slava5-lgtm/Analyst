...
#         summa += i
#    print(summa)
# n = int(input(' Введите число которому надо подсчитать сумму всех элементов ')) # 5
# sumNumbers(n) # 15

# Программный код, который мы написали прекрасно справляется с поставленной задачей. Давайте изменим наш код и добавим в него return. НО перед этим давайте вспомним, что делает
# return:
